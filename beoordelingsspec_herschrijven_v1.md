...
`schrijfspec_herschrijven_v1.md`**, en dat is met opzet: als de judge een eigen interpretatie
...
> Onder deze spec staan `humanisering_nl.md`, `stijlregister_nl.md` en `correcties_nl.md`: > dezelfde bestanden die de schrijver kreeg. Waar deze spec ernaar verwijst, kun je ze dus echt
...
- **Overzicht (1):** echte "Wil je …"-haak? voordelen i.p.v. losse features? persona-toon? geen marketing?
  **Drie punten die hier het vaakst misgaan:**
  ...
  (g) *Begint de tweede zin met "In deze training leer je …" (of "Tijdens deze training …")?* De code flagt dit al, maar jij beoordeelt de uitzondering: past die opening hier echt niet, of hangt het antwoord gewoon los van de vraag? Een kaal "Je leert …" of "Je werkt met …" is het laatste.
...
- **Modules (3):** modules niet-overlappend en dekkend voor het aantal dagen? actief geformuleerd? sub-bullets parallel en samen een sluitend verhaal? Staan de sub-bullets op het niveau van de kern, of is een dunne bron aangevuld met diepte die de training niet levert?
  **En: is het een programma of een inhoudsopgave?** Het richtgetal is 4 modules bij één dag, 5 bij twee tot drie dagen en 6 vanaf vier dagen. Zes of zeven modules met overal vier tot vijf sub-bullets is bijna dertig regels; kijk dan of twee modules eigenlijk één onderwerp zijn. Dat is een `fail` met de samenvoeging als reden, niet met "te veel modules": noem welke twee.
...
goedgekeurde actualisering. Onderscheid scherp, want dit is waar auto-herschrijven fout gaat:
...
- **Wél afrekenen: een versmalde reikwijdte.** De bron is ook de maatstaf voor hoe *breed*
  een claim is. Noemt de bron velden, rollen of sectoren als voorbeelden van waar de training
  van pas komt ("Of je nu in communicatie, beleid of HR werkt: …"), en maakt het concept er
...
- **Liggende streepjes** (em-dash of en-dash)? Die horen nergens in de tekst; de code vuurt er hard op, dus in een concept dat bij jou komt hoort er geen te staan. Zie je er toch een, meld hem dan: dan is er iets buiten de check om gelopen.
